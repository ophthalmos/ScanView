...
; der Ordner enthält dann x64\ (native Tesseract-DLLs) und tessdata\; die EXE ist per
; PlatformTarget 64-bit, die x86-Natives des Tesseract-Pakets filtert das Target
; PruneX86Natives in der csproj heraus.
; ============================================================================
